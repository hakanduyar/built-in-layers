...
// single column below (DESIGN_SYSTEM §15). TASK-007: one section-level
// reveal on scroll for the whole list, matching LayerExplorerIntro's
// treatment of its own definition list.
